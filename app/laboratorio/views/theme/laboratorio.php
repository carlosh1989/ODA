                    ...
                    <nav class="navbar navbar-default navbar-fixed-side">
                        <div class="container">
                            <div class="navbar-header">
                                ...
                                <i class="fa fa-hospital-o fa-2x" aria-hidden="true"></i> LABORATORIO</a>
                            </div>
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    <li style="background: #E9E9E9;"><a  href="<?php echo baseUrl ?>laboratorio/donantes"><i class="fa fa-user-o"></i> DONANTES</a></li>
                                </ul>
